...
export class CreateOrderTable implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createForeignKey(
      'orders',
      new TableForeignKey({
        name: 'fk_orders_inventory_item_id',
    ...
    await queryRunner.createIndex(
      'orders',
      new TableIndex({
        name: 'idx_orders_inventory_item_id',
        columnNames: ['inventory_item_id'],
      })
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.dropIndex('orders', 'idx_orders_inventory_item_id');
    await queryRunner.dropIndex('orders', 'idx_orders_status');
    await queryRunner.dropForeignKey('orders', 'fk_orders_user_id');
    await queryRunner.dropForeignKey('orders', 'fk_orders_inventory_item_id');
